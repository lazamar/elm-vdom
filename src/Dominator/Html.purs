...
value with no attributes and one child:: ∀ msg.
...
[program]:: ∀ msg. http:: ∀ msg.//package.elm-lang.org/packages/elm-lang/core/latest/Platform#Program
[tea]:: ∀ msg. https:: ∀ msg.//guide.elm-lang.org/architecture/
-}
beginnerProgram
  	:: ∀ msg model eff. 
  	{ model :: model
...
[program]:: ∀ msg. http:: ∀ msg.//package.elm-lang.org/packages/elm-lang/core/latest/Platform#Program
[here]:: ∀ msg. https:: ∀ msg.//guide.elm-lang.org/interop/javascript.html
-}
-- programWithFlags
--   :: ∀ msg. { init :: ∀ msg. flags -> (model, Cmd msg)
