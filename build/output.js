...
(function(exports) {
  ...
  var style = function (a) {
      return $foreign.style_(Data_List.fromFoldable(Data_Foldable.foldableArray)(a));
  }; 
  var node = function (s) {
      return function (p) {
          return function (c) {
  ...
  var functorNode = new Data_Functor.Functor($foreign.nodeMap);
  var defaultOptions = {
...
(function(exports) {
  ...
  var Prelude = PS["Prelude"];        
  var program = function (model) {
      return function (updateRaw) {
          return function (view) {
            
              // Convert Array (Eff) into List (Eff) 
  var update = function (msg) {
                  return function (m) {
                      return Data_Functor.map(Data_Tuple.functorTuple)(Data_List.fromFoldable(Data_Foldable.foldableArray))(updateRaw(msg)(m));
                  };
              };
              return $foreign.programImpl(Elm_Native_Scheduler.scheduler)(Elm_Native_VirtualDom.normalRenderer)(model)(update)(view);
          };
      };
  };
...
(function(exports) {
  ...
  var view = function (model) {
      return Data_Functor.map(Elm_Native_VirtualDom.functorNode)(Data_Function["const"](LogSomething.value))(Elm_Native_VirtualDom.node("div")([ Elm_Native_VirtualDom.property("id")(Elm_Json_Encode.string("greeting")), Elm_Native_VirtualDom.on("click")(Elm_Json_Decode.succeed(Clicked.value)), Elm_Native_VirtualDom.style([ new Data_Tuple.Tuple("color", "blue") ]) ])([ Elm_Native_VirtualDom.text(model) ]));
  };
  var update = function (msg) {
      return function (model) {
          ...
          if (msg instanceof LogSomething) {
              return new Data_Tuple.Tuple(model, [ Control_Bind.bind(Control_Monad_Cont_Trans.bindContT(Control_Monad_Eff.bindEff))(Async.fromAff(Network_HTTP_Affjax.get(Network_HTTP_Affjax_Response.responsableString)("http://google.com")))(function (v) {
          ...
          if (msg instanceof Clicked) {
              return new Data_Tuple.Tuple(model + "and on", [ Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Cont_Trans.bindContT(Control_Monad_Eff.bindEff))(Control_Monad_Eff_Class.liftEff(Control_Monad_Cont_Trans.monadEffContT(Control_Monad_Eff_Class.monadEffEff))(Control_Monad_Eff_Console.log("Clicked!")))(function () {
                  return Control_Bind.bind(Control_Monad_Cont_Trans.bindContT(Control_Monad_Eff.bindEff))(Async.makeAsync($foreign.repeat))(function (v) {
          ...
          throw new Error("Failed pattern match at Main line 41, column 9 - line 62, column 80: " + [ msg.constructor.name ]);
      };
  };
