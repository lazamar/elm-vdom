...
(function(exports) {
  ...
  var Data_Tuple = PS["Data.Tuple"];
  var Elm_Native_Core = PS["Elm.Native.Core"];
  var Elm_Native_Utils = PS["Elm.Native.Utils"];
...
(function(exports) {
  ...
  var DoSomething = (function () {
      ...
      DoSomething.value = new DoSomething();
      return DoSomething;
  })();
  ...
  var view = function (model) {
      return Elm_Native_VirtualDom.node("div")(new Data_List_Types.Cons(Elm_Native_VirtualDom.property("id")(Elm_Json_Encode.string("greeting")), new Data_List_Types.Cons(Elm_Native_VirtualDom.on("click")(Elm_Json_Decode.succeed(DoSomething.value)), new Data_List_Types.Cons(Elm_Native_VirtualDom.style(new Data_List_Types.Cons(new Data_Tuple.Tuple("color", "blue"), Data_Monoid.mempty(Data_List_Types.monoidList))), Data_Monoid.mempty(Data_List_Types.monoidList)))))(new Data_List_Types.Cons(Elm_Native_VirtualDom.text(model), Data_Monoid.mempty(Data_List_Types.monoidList)));
  };
  var update = function (dictMonoid) {
      return function (msg) {
          return function (model) {
              return new Data_Tuple.Tuple(model + " and on", Data_Monoid.mempty(dictMonoid));
          };
      };
  };
  var main = Elm_Native_Platform.program("This goes on")(update(Data_List_Types.monoidList))(view);
  exports["main"] = main;
