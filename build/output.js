...
(function(exports) {
  ...
  var main = (function () {
      var view = function (m) {
          return Elm_VirtualDom.node("div")(new Data_List_Types.Cons(Elm_VirtualDom.property("id")(Elm_Json_Encode.string("greeting")), new Data_List_Types.Cons(Elm_VirtualDom.on("click")(Elm_Json_Decode.succeed(DoSomething.value)), new Data_List_Types.Cons(Elm_VirtualDom.style(new Data_List_Types.Cons(new Data_Tuple.Tuple("color", "blue"), Data_Monoid.mempty(Data_List_Types.monoidList))), Data_Monoid.mempty(Data_List_Types.monoidList)))))(new Data_List_Types.Cons(Elm_VirtualDom.text(m), Data_Monoid.mempty(Data_List_Types.monoidList)));
      };
      return function __do() {
          Elm_VirtualDom.renderOnce(view)("Initial Mode")();
