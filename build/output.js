...
(function(exports) {
  ...
  var Prelude = PS["Prelude"];        
  var program = $foreign.programImpl(Elm_Native_Scheduler.scheduler)(Elm_Native_VirtualDom.normalRenderer);
...
(function(exports) {
  ...
  var view = function (model) {
      return Elm_Native_VirtualDom.node("div")(new Data_List_Types.Cons(Elm_Native_VirtualDom.property("id")(Elm_Json_Encode.string("greeting")), new Data_List_Types.Cons(Elm_Native_VirtualDom.on("click")(Elm_Json_Decode.succeed(Clicked.value)), new Data_List_Types.Cons(Elm_Native_VirtualDom.style(new Data_List_Types.Cons(new Data_Tuple.Tuple("color", "blue"), Data_Monoid.mempty(Data_List_Types.monoidList))), Data_Monoid.mempty(Data_List_Types.monoidList)))))(new Data_List_Types.Cons(Elm_Native_VirtualDom.text(model), Data_Monoid.mempty(Data_List_Types.monoidList)));
  };
  var update = function (msg) {
      return function (model) {
          if (msg instanceof DoNothing) {
              return new Data_Tuple.Tuple(model, Data_Monoid.mempty(Data_List_Types.monoidList));
          };
          if (msg instanceof LogSomething) {
              return new Data_Tuple.Tuple(model, Control_Applicative.pure(Data_List_Types.applicativeList)(Control_Bind.bind(Control_Monad_Cont_Trans.bindContT(Control_Monad_Eff.bindEff))(Async.fromAff(Network_HTTP_Affjax.get(Network_HTTP_Affjax_Response.responsableString)("http://google.com")))(function (v) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Cont_Trans.bindContT(Control_Monad_Eff.bindEff))(Control_Monad_Eff_Class.liftEff(Control_Monad_Cont_Trans.monadEffContT(Control_Monad_Eff_Class.monadEffEff))(Control_Monad_Eff_Console.log("Logging something")))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Cont_Trans.bindContT(Control_Monad_Eff.bindEff))(Control_Monad_Eff_Class.liftEff(Control_Monad_Cont_Trans.monadEffContT(Control_Monad_Eff_Class.monadEffEff))(Control_Monad_Eff_Console.logShow(Data_Either.showEither(Control_Monad_Eff_Exception.showError)(Data_Show.showString))(Data_Functor.map(Data_Either.functorEither)(function (v1) {
                          return v1.response;
                      })(v))))(function () {
          ...
          if (msg instanceof Clicked) {
              return new Data_Tuple.Tuple(model + "and on", Control_Applicative.pure(Data_List_Types.applicativeList)(Control_Monad_Eff_Class.liftEff(Control_Monad_Cont_Trans.monadEffContT(Control_Monad_Eff_Class.monadEffEff))(function __do() {
                  Control_Monad_Eff_Console.log("Clicked!")();
                  return LogSomething.value;
              })));
          };
          throw new Error("Failed pattern match at Main line 36, column 9 - line 55, column 34: " + [ msg.constructor.name ]);
      };
  };
  var main = Elm_Native_Platform.program("This goes on")(update)(view);
  exports["main"] = main;
