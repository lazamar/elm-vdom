...
(function(exports) {
  ...
  var view = function (model) {
      return Data_Functor.map(Elm_Native_VirtualDom.functorNode)(Data_Function["const"](LogSomething.value))(Elm_Html.div([ Elm_Html_Attributes.id("greeting"), Elm_Html_Events.onClick(Clicked.value), Elm_Html_Attributes.style([ new Data_Tuple.Tuple("color", "blue") ]) ])([ Elm_Html.text(model) ]));
  };
