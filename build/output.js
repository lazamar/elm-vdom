...
(function(exports) {
  ...
  var view = function (model) {
      return Elm_Native_VirtualDom.node("div")([ Elm_Native_VirtualDom.property("id")(Elm_Json_Encode.string("greeting")), Elm_Native_VirtualDom.on("click")(Elm_Json_Decode.succeed(Clicked.value)), Elm_Native_VirtualDom.style([ new Data_Tuple.Tuple("color", "blue") ]) ])([ Elm_Native_VirtualDom.text(model) ]);
  };
  var update = function (msg) {
      return function (model) {
