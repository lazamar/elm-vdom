...
(function(exports) {
  ...
  exports["semigroupEff"] = semigroupEff;
  exports["monoidEff"] = monoidEff;
...
(function(exports) {
  ...
  var Data_Function = PS["Data.Function"];
  var Prelude = PS["Prelude"];        
  var toAsync = function (eff) {
      return Control_Monad_Cont_Trans.ContT(function (trymebaby) {
  ...
  var runAsync = Control_Monad_Cont_Trans.runContT;
...
(function(exports) {
  ...
  var Prelude = PS["Prelude"];        
  var program = $foreign.programImpl(Data_Function.flip(Async.runAsync)(Data_Function["const"](Data_Monoid.mempty(Control_Monad_Eff.monoidEff(Data_Monoid.monoidUnit)))))(Elm_Native_Scheduler.scheduler)(Elm_Native_VirtualDom.normalRenderer);
  ...
  var update = function (msg) {
      return function (model) {
          ...
          if (msg instanceof LogSomething) {
              return new Data_Tuple.Tuple(model, Data_Function.flip(Data_List_Types.Cons.create)(Data_Monoid.mempty(Data_List_Types.monoidList))(Async.toAsync(Data_Functor.map(Control_Monad_Eff.functorEff)(Data_Function["const"](DoNothing.value))(Control_Monad_Eff_Console.log("Logging something!")))));
          };
          if (msg instanceof Clicked) {
              return new Data_Tuple.Tuple(model + "and on", Data_Function.flip(Data_List_Types.Cons.create)(Data_Monoid.mempty(Data_List_Types.monoidList))(Async.toAsync(Data_Functor.map(Control_Monad_Eff.functorEff)(Data_Function["const"](LogSomething.value))(Control_Monad_Eff_Console.log("Clicked!")))));
          };
          throw new Error("Failed pattern match at Main line 37, column 9 - line 56, column 34: " + [ msg.constructor.name ]);
      };
  };
