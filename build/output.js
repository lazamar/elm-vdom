...
(function(exports) {
  ...
  var view = function (model) {
      return Data_Functor.map(Elm_Native_VirtualDom.functorNode)(Data_Function["const"](LogSomething.value))(Elm_Html.div([ Elm_Html_Attributes.id("greeting"), Elm_Native_VirtualDom.on("click")(Elm_Json_Decode.succeed(Clicked.value)), Elm_Html_Attributes.style([ new Data_Tuple.Tuple("color", "blue") ]) ])([ Elm_Html.text(model) ]));
  };
  var update = function (msg) {
      return function (model) {
          ...
          throw new Error("Failed pattern match at Main line 46, column 9 - line 67, column 81: " + [ msg.constructor.name ]);
      };
  };
